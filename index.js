...
client.on('interactionCreate', async interaction => {
                if (interaction.isButton()) {
                                    ...
                                    if (!config || !config.recruitment || !config.recruitment.open) {
                                                            return interaction.reply({ content: '\u274C \u041F\u0440\u0438\u0435\u043C \u0437\u0430\u044F\u0432\u043E\u043A \u0441\u0435\u0439\u0447\u0430\u0441 \u0437\u0430\u043A\u0440\u044B\u0442.', ephemeral: true });
                                    }

                    const modal = new ModalBuilder()
                                        .setCustomId('apply_modal')
                                        .setTitle(config.recruitment.title || '\u041F\u043E\u0434\u0430\u0447\u0430 \u0437\u0430\u044F\u0432\u043A\u0438');

                    modal.addComponents(
                                            new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('q1').setLabel('\u041A\u0430\u043A \u0432\u0430\u0441 \u0437\u043E\u0432\u0443\u0442?').setStyle(TextInputStyle.Short).setRequired(true)),
                                            new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('q2').setLabel('\u0421\u043A\u043E\u043B\u044C\u043A\u043E \u0432\u0430\u043C \u043B\u0435\u0442?').setStyle(TextInputStyle.Short).setRequired(true)),
                                            new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('q3').setLabel('\u041F\u043E\u0447\u0435\u043C\u0443 \u0432\u044B \u0445\u043E\u0442\u0438\u0442\u0435 \u043A \u043D\u0430\u043C?').setStyle(TextInputStyle.Paragraph).setRequired(true))
                                        );
                    ...
                    if (config && config.adminChannelId) {
                                            ...
                                            if (channel) {
                                                                        const embed = new EmbedBuilder()
                                                                            ...
                                                                            .addFields(
                                                                                        { name: '\u0418\u043C\u044F', value: interaction.fields.getTextInputValue('q1') || '\u041D\u0435\u0442 \u043E\u0442\u0432\u0435\u0442\u0430' },
                                                                                        { name: '\u0412\u043E\u0437\u0440\u0430\u0441\u0442', value: interaction.fields.getTextInputValue('q2') || '\u041D\u0435\u0442 \u043E\u0442\u0432\u0435\u0442\u0430' },
                                                                                        { name: '\u041F\u043E\u0447\u0435\u043C\u0443 \u0445\u043E\u0447\u0435\u0442 \u043A \u043D\u0430\u043C', value: interaction.fields.getTextInputValue('q3') || '\u041D\u0435\u0442 \u043E\u0442\u0432\u0435\u0442\u0430' }
                                                                                                            )
