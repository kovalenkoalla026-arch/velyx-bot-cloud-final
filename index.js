...
client.on('messageUpdate', async (oldMessage, newMessage) => {
        ...
        const embed = new EmbedBuilder().setTitle('\u270F\uFE0F \u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u043E').setColor('#feca57').addFields({ name: '\u0410\u0432\u0442\u043E\u0440', value: `${oldMessage.author.tag} (<@${oldMessage.author.id}>)`, inline: true }, { name: '\u041A\u0430\u043D\u0430\u043B', value: `<#${oldMessage.channelId}>`, inline: true }, { name: '\u0421\u0442\u0430\u0440\u043E\u0435 \u0441\u043E\u0430\u0431\u0449\u0435\u043D\u0438\u0435', value: oldMessage.content || '*[\u0411\u0435\u0437 \u0442\u0435\u043A\u0441\u0442\u0430]*' }, { name: '\u041D\u043E\u0432\u043E\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435', value: newMessage.content || '*[\u0411\u0435\u0437 \u0442\u0435\u043A\u0441\u0442\u0430]*' }).setTimestamp();
