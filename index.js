...
const guildConfigSchema = new mongoose.Schema({
            ...
            recruitment: { open: { type: Boolean, default: false }, title: { type: String, default: 'Application Submission' }, description: { type: String, default: 'Click the button below to apply.' }, questions: { type: Array, default: [] }, approvalRole: { type: String, default: '' }, approvalMessage: { type: String, default: '' } },
